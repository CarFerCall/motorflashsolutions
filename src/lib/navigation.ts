...
const MENU_LABEL_DICT: Record<string, { en: string; zh: string }> = {
  ...
  'Dealer / Stock': { en: 'Dealer / Stock', zh: 'Dealer / 库存' },
  'Multipublicador': { en: 'Multipublisher', zh: 'Multipublisher' },
  'Photocall IA (Spyne)': { en: 'Photocall AI (Spyne)', zh: 'Photocall AI (Spyne)' },
  'Imagen avanzada + RCS': { en: 'Advanced Image + RCS', zh: '高级图像 + RCS' },
  'Motorflash IA': { en: 'Motorflash AI', zh: 'Motorflash AI' },
  ...
  'Lead Exclusive (5 Estrellas)': { en: 'Lead Exclusive (5-Star)', zh: 'Lead Exclusive(5 星)' },
