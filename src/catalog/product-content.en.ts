    ...
    sections: [
      {
        ...
        items: [
          ...
          { title: 'Dedicated GEO, SEA and Social teams', description: 'A team of experts in GEO (the new SEO — visibility on Google and in AI search), a dedicated SEA team and a third one focused on Social Ads to grow your business.', icon: 'group' },
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Unique in the market at verifying version and extras of every listing by VIN — other multipublishers estimate from the plate; we publish verified manufacturer data.",
          'Minimum commitment of 6 months. No invoice surprises and no hidden costs.',
        ],
      },
      {
        type: 'spotlight',
        badge: 'Unique in the market',
        title: 'Premium VIN-based creation: we verify version and extras on every listing',
        lead: 'Motorflash is the only multipublisher in the market able to automatically identify the exact version and real factory-fitted optional equipment of each vehicle from the VIN. Others estimate from the plate; we publish verified manufacturer data — with the reliability that brings to your listing, your portal SEO and your conversion.',
        bullets: [
          'Exact version and variant by VIN — no interpretation errors.',
          'Optional extras and equipment detected and itemised, one by one.',
          'Factory-grade accuracy on every listing: fewer returns, fewer disputes.',
          'Maximum information density to rank better on every portal.',
        ],
        icon: 'verified',
      ...
      },
      {
        ...
        lead: 'Four ways to create the listing depending on the reliability and time you want to invest. VIN-based Premium creation — our differentiator — hands you the exact version and extras of every unit with zero effort.',
        items: [
          { title: 'Premium creation (by VIN) · Unique in the market', description: 'We enter the VIN and automatically pull the exact version and the real factory-fitted optional equipment of that specific unit. No other multipublisher does it: while competitors estimate from the plate, you publish verified manufacturer data. Includes advanced creation.', icon: 'workspace_premium' },
