...
export const productContent: Record<string, ProductContent> = {
  ...
  'spyne': {
    subtitle: 'Transforma tus imágenes con inteligencia artificial',
    sections: [
      {
        type: 'features',
        title: 'Imágenes y vídeos que convierten',
        lead: 'Spyne combina inteligencia artificial con la simplicidad de una app para que cualquier persona pueda crear contenido visual de calidad profesional. Sin estudio fotográfico, sin conocimientos técnicos.',
        items: [
          { title: 'Vídeos 360° que venden', description: 'Crea vídeos 360° interactivos de tus vehículos de forma automática. El comprador puede girar el coche y explorar cada detalle desde su móvil, aumentando el tiempo en ficha y la conversión.', icon: 'photo_camera' },
          { title: '+100 transformaciones de IA', description: 'Eliminación de fondos, mejora de iluminación, corrección de color, añadir fondos de concesionario, eliminación de reflejos y mucho más. Todo de forma automática y con resultados consistentes.', icon: 'auto_awesome' },
          { title: 'Integración DMS automática', description: 'La subida de fotos es automática y se acopla al sistema de los concesionarios. No necesitas cambiar tus procesos actuales: Spyne se integra con tu DMS y el stock se actualiza solo.', icon: 'sync_alt' },
          { title: 'Carlens App para iOS y Android', description: 'Aplicación sencilla disponible en iOS y Android para hacer las fotos directamente desde el concesionario. No se necesitan conocimientos técnicos: guía paso a paso en pantalla para cada ángulo.', icon: 'smartphone' },
          { title: 'Calidad consistente en todo el stock', description: 'Todas las fotos siguen el mismo estándar visual. Tu catálogo se ve profesional y coherente en todos los portales y en tu web.', icon: 'verified' },
          { title: 'Procesado ultrarrápido', description: 'Procesa inventarios completos en minutos. Reduce el tiempo de publicación de stock hasta en un 80%.', icon: 'bolt' },
        ],
      },
      {
        type: 'highlights',
        title: 'Fotos de calidad profesional desde el aparcamiento',
        lead: 'Hacer fotos de calidad para un catálogo de coches requería equipo caro, fotógrafo especializado y horas de edición. Con Spyne, cualquier persona del concesionario puede hacerlo en minutos.',
        highlights: [
          { title: 'Fotografía guiada', description: 'Ángulos perfectos sin conocimientos técnicos' },
          { title: 'Procesado en segundos', description: 'IA en la nube, resultados inmediatos' },
          { title: 'Vídeo 360° automático', description: 'Experiencia interactiva para el comprador' },
          { title: 'Integración DMS', description: 'Stock siempre actualizado sin trabajo manual' },
        ],
        bullets: [
          'Carlens App: guía en pantalla para cada ángulo del vehículo. Cero margen de error.',
          'IA en la nube: las fotos se procesan automáticamente con más de 100 transformaciones disponibles.',
          'Fondos de concesionario, eliminación de reflejos y mejora de iluminación automáticos',
          'Integración con los principales portales de automoción y con tu DMS',
          'Vídeos 360° interactivos generados automáticamente desde las fotos',
        ],
      },
      {
        type: 'process',
        ...
        steps: [
          { title: 'Fotografía con la app', description: 'El operario abre la Carlens App, selecciona el vehículo y sigue la guía en pantalla para capturar todos los ángulos. Sin técnica ni equipamiento especial.' },
          { title: 'Procesado automático con IA', description: 'Las imágenes se envían a la nube y la IA aplica las transformaciones configuradas: fondos, mejoras de iluminación, eliminación de reflejos y generación del vídeo 360°.' },
          { title: 'Publicación en todos los portales', description: 'El vehículo con sus fotos y vídeo se publica automáticamente en tu web, portales integrados y DMS. Todo sincronizado sin intervención manual.' },
        ],
      },
      {
        type: 'cta',
        title: '¿Quieres catálogos de coches de calidad profesional sin esfuerzo?',
        lead: 'Solicita una demo y te mostramos cómo Spyne puede transformar el catálogo de tu concesionario en minutos.',
      },
    ],
  },
  'motorflash-message': {
