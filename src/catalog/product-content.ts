...
export const productContent: Record<string, ProductContent> = {
  ...
  'motorflash-message': {
    subtitle: 'WhatsApp Business profesional, multi-agente y RGPD — 6 años en producción con +100 clientes',
    sections: [
      {
        type: 'highlights',
        title: 'El canal #1 de tus clientes, gestionado como un canal corporativo',
        lead: 'WhatsApp es la primera app de mensajería del mundo: 98% de ratio de apertura y conversiones del 45–60% frente al 2,5–5% del email/SMS. Tus clientes ya están ahí. MF Message convierte ese canal en una herramienta de empresa con permisos, dashboard, plantillas y trazabilidad.',
        highlights: [
          { title: '98%', description: 'Ratio de apertura WhatsApp vs +20% del email/SMS' },
          { title: '45-60%', description: 'Conversión vs 2,5-5% en canales tradicionales' },
          { title: '+100', description: 'Clientes ya operando con MF Message · 6 años en producción' },
          { title: '100% RGPD', description: 'Encriptación e2e, consentimiento explícito, transparencia total' },
        ],
        bullets: [
          'Atención al cliente (54%) y soporte en el proceso de venta (42%) son los usos más demandados.',
          'Tus comerciales atienden varias conversaciones simultáneamente — la naturaleza asíncrona del canal multiplica su capacidad.',
          'Multimedia nativa: vídeo, documentos, audio y enlaces aumentan la eficacia del contacto frente a una llamada.',
        ],
      },
      {
        type: 'features',
        title: 'Funcionalidades principales de MF Message',
        lead: 'Plataforma multicanal, multiempresa y multi-agente desarrollada por Motorflash sobre WhatsApp Business Platform. Lo que un equipo necesita para tratar WhatsApp como un canal de empresa.',
        items: [
          { title: 'Multi-agente con enrutamiento', description: 'Conversaciones repartidas automáticamente a grupos de respuesta por especialización, horario o zona geográfica. Asignación al agente y posibilidad de transferencia sin perder el hilo.', icon: 'group' },
          { title: 'Plantillas y respuestas rápidas', description: 'Biblioteca de plantillas aprobadas por Meta para envíos saliente + respuestas rápidas que los agentes lanzan con un atajo. Multilenguaje en ES, EN, DE, FR, IT, PT.', icon: 'description' },
          { title: 'Etiquetado, notas y multimedia', description: 'Cada conversación se etiqueta y permite notas internas. Compatible con todos los formatos que admite Meta: fotos, vídeos, audio, documentos y enlaces.', icon: 'label' },
          { title: 'Dashboard y analítica', description: 'Panel estándar de actividad a nivel de empresa y grupo: volumen, tiempos, asignaciones y motivos de cierre. Los datos internos quedan disponibles para usos específicos del cliente.', icon: 'analytics' },
          { title: 'Bots y automatización', description: 'Automatización total o parcial con BOTs en cualquier punto del flujo. Mensajes de servicio (fuera de horario, vacaciones) gestionados solos.', icon: 'smart_toy' },
          { title: 'IVR Call Deflection', description: 'Integración con IVRs para desviar tráfico telefónico a WhatsApp dentro del propio diálogo de la centralita. Ahorra costes y mejora la experiencia.', icon: 'phone_forwarded' },
          { title: 'APIs e integración con CRM', description: 'Apificación completa para integrar con CRM4YOU, Salesforce, HubSpot u otros. Embebible en cualquier CRM con autologin del agente.', icon: 'sync_alt' },
          { title: 'App móvil para iOS y Android', description: 'El módulo conversacional está disponible en App Store y Google Play, con el mismo funcionamiento que en escritorio y sincronización en tiempo real.', icon: 'smartphone' },
        ],
      },
      {
        type: 'highlights',
        title: '4 modalidades de WhatsApp · sólo una es de empresa',
        lead: 'WhatsApp personal y WhatsApp Business App están pensados para uso individual o autónomos. WhatsApp Business Platform es la versión de empresa, y MF Message es nuestra plataforma sobre esa base con todo el dashboard, los permisos y la autogestión incluidos.',
        highlights: [
          { title: 'WhatsApp', description: 'Personal · sin perfil verificado ni multi-agente' },
          { title: 'Business App', description: 'Autónomos · 1 cuenta, plantillas y automatización light' },
          { title: 'Business Platform', description: 'Empresas · Meta API sin dashboard ni gestión incluidos' },
          { title: 'MF Message', description: 'Sobre Business Platform · dashboard, permisos, campañas y autogestión' },
        ],
        bullets: [
          'Sello de verificación de cuenta que evita la suplantación.',
          'Encriptación de extremo a extremo. Sin envíos sin consentimiento explícito.',
          'Acceso múltiple: 1 cuenta WhatsApp y N agentes trabajando simultáneamente.',
          'Plataforma 100% adaptada al RGPD con transparencia total de datos a solicitud del cliente.',
        ],
      },
      {
        type: 'features',
        title: '5 beneficios inmediatos para tu equipo',
        lead: 'Para la mayor parte de las aplicaciones, los clientes prefieren un mensaje a una llamada. MF Message convierte ese canal en una ventaja operativa concreta.',
        items: [
          { title: 'Control de operaciones', description: 'Todas las transacciones se registran. 4 niveles de permisos (Administrador, Supervisor, Agente avanzado, Agente limitado) para una estructura de gestión adecuada.', icon: 'monitoring' },
          { title: 'Flexibilidad de configuración', description: 'Un número de contacto por departamento o empresa, N grupos de respuesta, agentes en uno o varios grupos, transferencias entre grupos y escalado entre empresas.', icon: 'tune' },
          { title: 'Reducción de costes', description: 'Multi-conversación simultánea, asíncrono y multimedia. La transferencia mantiene el hilo y abarata los procesos internos.', icon: 'savings' },
          { title: 'Cobertura del ciclo de cliente', description: 'Captación con campañas WhatsApp, seguimiento de leads, atención y soporte postventa, up-selling y cross-selling. Una sola herramienta para todo el ciclo.', icon: 'cycle' },
          { title: 'Automatizable e integrable', description: 'Nivel de apificación que permite integrarlo con tu CRM y tu IVR. Experiencias exitosas con CRMs propios y de mercado.', icon: 'integration_instructions' },
          { title: 'Especialista, no generalista', description: 'Plataforma desarrollada por Motorflash, 6 años en producción con +100 clientes. Control total del producto, interlocución local en España y precio competitivo.', icon: 'verified' },
        ],
      },
      {
        type: 'process',
        title: 'En 2 semanas estás atendiendo desde MF Message',
        steps: [
          { title: 'Firma + alta en META (sesión de 15 min)', description: 'Sólo necesitas un número de teléfono que será el "WhatsApp" de tus clientes y tu Identificador de Facebook Business Manager (FBM ID). Te ayudamos a localizarlo si no lo tienes.' },
          { title: 'Alta en WhatsApp Business Platform', description: 'Damos de alta el número en tu Business Manager de META con la sesión guiada de 15 min. A partir de aquí ya pueden empezar a llegar conversaciones.' },
          { title: 'Configuración de líneas, grupos y usuarios', description: 'Configuramos las líneas, los grupos de respuesta, los agentes, las plantillas aprobadas, los mensajes de servicio y los niveles de permisos según tu estructura.' },
          { title: 'Integración con terceros (opcional) y arranque', description: 'Si lo necesitas, conectamos MF Message con tu CRM o IVR. Formación al equipo y listo para empezar a usar la plataforma en producción.' },
        ],
      },
      {
        type: 'cta',
        title: '¿Quieres ver MF Message con tu número real?',
        lead: 'Solicita una demo de 30 minutos. Te enseñamos un caso real de un grupo de tu tamaño y, si tienes el FBM ID a mano, podemos arrancar el alta en META en la misma llamada.',
      },
    ],
  },
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Diferenciador real: exportamos los anuncios con el equipamiento extra de cada unidad perfectamente desglosado — algo que la mayoría de multipublicadores NO hace.',
      ...
      },
      {
        ...
        lead: 'Tres maneras de crear el anuncio según el nivel de fiabilidad y tiempo que quieras dedicarle. Desde la creación manual a la creación premium por bastidor (VIN) con equipamiento opcional incluido automáticamente.',
        items: [
          ...
          { title: 'Creación premium (por VIN/bastidor)', description: 'Con el bastidor obtenemos automáticamente toda la información del vehículo incluida la versión y los extras. Máxima fiabilidad en el listado. Incluye la creación avanzada.', icon: 'verified' },
