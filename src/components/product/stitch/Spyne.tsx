...
const COPY: Record<LocaleKey, SpyneCopy> = {
  ...
  ca: {
    badge: 'POWERED BY CARLENS · SPYNE AI',
    title1: 'Ven abans amb ',
    titleAccent: 'Photocall IA',
    heroLead: "El 40% dels compradors decideixen sense veure el cotxe. Transforma fotos d'aparcament en imatges d'estudi professional amb +150 funcionalitats d'IA. Sense estudi, sense fotògraf, sense esperes.",
    ctaDemo: 'PROVA DEMO GRATIS',
    ctaServices: 'VEURE TOTS ELS SERVEIS',
    marketEyebrow: 'EL MERCAT AVUI',
    marketTitle: 'Les teves fotos són el teu millor comercial — la majoria de clients ja no veuen el cotxe',
    marketStats: [
      { v: '95%', l: "De concessionaris publica el seu estoc online" },
      { v: '40%', l: 'De compradors decideix sense veure el cotxe en persona' },
      { v: '4,2', l: 'Webs visita un comprador abans de decidir' },
    ],
    marketSource: 'Font: Google Research · Cox Automotive',
    capsEyebrow: 'CAPACITATS PRINCIPALS',
    capsTitle: "Una sola eina. Tota la feina del fotògraf, en automàtic.",
    bigCardTitle: 'Substitució de fons i plataforma giratòria',
    bigCardDesc: "La IA detecta el vehicle, el retalla i reemplaça el fons per un de professional o el teu personalitzat. A més genera la plataforma sota el cotxe perquè sembli pres en estudi. Arrossega el divisor per comparar.",
    beforeLabel: 'Abans',
    afterLabel: 'Després',
    spinTitle: 'Vídeo Spin 360°',
    spinDesc: 'Vídeos interactius generats automàticament. El comprador gira el cotxe des del seu mòbil — més temps a la fitxa i més conversió.',
    spinTag: 'EXPERIÈNCIA INTERACTIVA',
    coherenceTitle: "Coherència professional a tot l'estoc",
    coherenceDesc: "Mateixa qualitat, mateix enquadrament, mateixos fons. El teu catàleg es veu impecable a cada portal sense dependre de l'operari que va fer la foto.",
    retouchTitle: 'Retoc automàtic de reflexos, ombres i matrícules',
    retouchDesc: 'Corregeix reflexos a la carrosseria i vidres, genera ombres realistes, cobreix la matrícula amb el teu logo i tinta els vidres. RGPD complert sense passos manuals.',
    retouchBullets: ['OMBRES I REFLEXOS GENERATS', 'MATRÍCULA SUBSTITUÏBLE', 'TINTAT DE VIDRES', 'LOGO INCRUSTAT AL FONS'],
    realEyebrow: 'EXEMPLE REAL',
    realTitle: 'Prova-ho tu: gira el vehicle 360°',
    realLead: 'El mateix que veuran els teus compradors a la fitxa. Clica i arrossega per girar-lo. Aquesta és una presa real processada amb Photocall IA, amb plataforma giratòria generada i hotspots interactius.',
    realBullets: [
      { icon: 'rotate_360', t: 'Vista completa des de qualsevol angle' },
      { icon: 'touch_app', t: 'Hotspots amb detalls del cotxe' },
      { icon: 'smartphone', t: 'Funciona igual al mòbil i a l\'escriptori' },
    ],
    realFootnote: "Si el visor triga a carregar, dona-li un parell de segons: descarrega els frames del cotxe.",
    spinFootnote: 'Visor 360° servit per Photocall IA · arrossega per girar',
    featuresEyebrow: "+150 FUNCIONALITATS D'IA",
    featuresTitle: '+100 transformacions i +50 deteccions automàtiques',
    featuresLead: "Cada foto passa per un pipeline d'IA que l'audita, la corregeix i la transforma. Aquests són alguns exemples del que fa per tu, automàticament.",
    features: [
      { i: 'wallpaper', t: 'Substitució de fons', d: 'Reemplaça el fons per estudi virtual o el teu personalitzat.' },
      { i: 'view_in_ar', t: 'Plataforma giratòria', d: 'Genera la plataforma/terra sota el cotxe en automàtic.' },
      { i: 'rotate_90_degrees_ccw', t: 'Vídeo Spin 360°', d: 'Vídeos interactius perquè el comprador giri el cotxe.' },
      { i: 'auto_fix_high', t: 'Reflexos i ombres', d: 'Corregeix reflexos a la carrosseria i vidres, ajusta ombres.' },
      { i: 'directions_car', t: 'Cobertura de matrícula', d: "Substitueix-la, oculta-la o cobreix-la amb el logo." },
      { i: 'blur_on', t: 'Tintat de vidres', d: 'Cobreix les finestres o el que es veu a través.' },
      { i: 'straighten', t: 'Correcció d\'inclinació', d: "Ajusta l'angle i la perspectiva del vehicle." },
      { i: 'auto_awesome', t: '+50 deteccions', d: 'Tipus de cotxe, pneumàtics, fang, danys, exposició, desenfocament…' },
      { i: 'verified', t: 'Logo incrustat', d: 'La teva marca al fons i a la matrícula sense que es noti.' },
      { i: 'airline_seat_recline_normal', t: "Millora d'interior", d: 'Corregeix interior i cobreix exteriors visibles per les finestres.' },
      { i: 'high_quality', t: 'Millora de resolució', d: "Auditoria automàtica de fotos antigues, més nitidesa i enfocament." },
      { i: 'aspect_ratio', t: 'Ajust per portal', d: 'Variants de mida per a cada portal i xarxa social.' },
    ],
    channelsEyebrow: '5 FORMES D\'INTEGRAR-HO',
    channelsTitle: 'Funciona amb el teu workflow actual. No al revés.',
    channelsLead: "Tria el canal o usa'n diversos en paral·lel: algú fa fotos amb l'app mentre el sistema puja les del DMS per API.",
    channels: [
      { i: 'smartphone', t: 'App iOS / Android', d: "Guia pas a pas per fer les fotos des de l'aparcament." },
      { i: 'monitor', t: 'Consola Carlens360', d: "Panell web amb totes les teves fotos, projectes i regles d'IA." },
      { i: 'api', t: 'API', d: 'Puja l\'inventari complet automàticament des del teu DMS.' },
      { i: 'integration_instructions', t: 'SDK', d: "Encasta el flux a la teva pròpia app de fabricant o grup." },
      { i: 'sync_alt', t: 'Integració DMS', d: "Ens connectem al teu workflow: concessionari → web → portal." },
    ],
    stats: [
      { v: '+150', l: 'FUNCIONALITATS IA', primary: true },
      { v: '5x', l: 'MÉS CLICS AL PORTAL' },
      { v: 'segons', l: 'PER FOTO PROCESSADA' },
      { v: '+30%', l: 'CONVERSIÓ A LEAD' },
    ],
    ctaTitle: "Llest per professionalitzar el teu inventari?",
    ctaLead: 'Uneix-te als concessionaris que ja fan servir Photocall IA per dominar el mercat digital.',
    setupLabel: 'Set up',
    galleryLabel: 'Galeria',
    spinLabel: 'Amb Spin 360°',
    customLabel: 'Fons personalitzat',
