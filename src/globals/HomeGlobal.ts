  ...
  fields: [
    {
      ...
      tabs: [
        ...
        {
          label: 'Nav sections',
          description: 'Anclas que aparecen en el menú flotante de la home.',
          fields: [
            {
              name: 'navSections',
              type: 'array',
              ...
              fields: [
                {
                  type: 'row',
                  fields: [
                    { name: 'anchor', type: 'text', label: 'ID (ancla DOM)', admin: { width: '40%', description: 'Slug DOM tipo "home-hero", "sobre-motorflash"...' } },
